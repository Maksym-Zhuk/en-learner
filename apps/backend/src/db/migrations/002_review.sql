...
CREATE TABLE IF NOT EXISTS review_cards (
    ...
    due_at           TEXT NOT NULL DEFAULT to_char(timezone('UTC', now()), 'YYYY-MM-DD"T"HH24:MI:SS"Z"'),
...
CREATE TABLE IF NOT EXISTS review_logs (
    ...
    interval_after  DOUBLE PRECISION NOT NULL DEFAULT 0,
    reviewed_at     TEXT NOT NULL DEFAULT to_char(timezone('UTC', now()), 'YYYY-MM-DD"T"HH24:MI:SS"Z"')
);
...
CREATE TABLE IF NOT EXISTS review_sessions (
    ...
    started_at  TEXT NOT NULL DEFAULT to_char(timezone('UTC', now()), 'YYYY-MM-DD"T"HH24:MI:SS"Z"'),
    finished_at TEXT,
