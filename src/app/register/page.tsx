    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 py-12">
        <div className="relative w-full max-w-[480px] bg-bg-surface border border-bg-subtle rounded-[24px] px-9 py-10 shadow-[0_12px_40px_rgba(0,0,0,0.5)]">
          ...
          <div className="text-text-muted text-[13px] text-center mb-7">Почни вивчати англійську вже сьогодні.</div>
          ...
          <div className="grid grid-cols-2 bg-bg-elevated border border-bg-subtle rounded-full p-1 relative mb-7">
            ...
            <button className="relative z-10 bg-transparent border-none text-text-secondary font-[inherit] text-[13px] font-medium h-9 cursor-pointer transition-colors" type="button" onClick={() => router.push(loginHref)}>Увійти</button>
            <button className="relative z-10 bg-transparent border-none text-white font-[inherit] text-[13px] font-medium h-9 cursor-pointer transition-colors" type="button">Зареєструватись</button>
          </div>
          ...
          <form onSubmit={handleSubmit} autoComplete="off">
            ...
            <div className="relative mb-4">
              ...
              />
              <label className="absolute left-11 top-4 text-text-muted text-[15px] pointer-events-none transition-all peer-focus:top-[7px] peer-focus:text-[11px] peer-focus:text-accent peer-[:not(:placeholder-shown)]:top-[7px] peer-[:not(:placeholder-shown)]:text-[11px] peer-[:not(:placeholder-shown)]:text-accent">Пароль (мін. 8 символів)</label>
          ...
          <p className="text-text-muted text-[13px] text-center" style={{ marginTop: 20, marginBottom: 0 }}>
            Вже є акаунт? <Link href={loginHref} className="text-accent">Увійти</Link>
          </p>
        </div>
      </section>
    </>
